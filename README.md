...
- **Apache Airflow** — автоматизация и планирование DAG  
- **ClickHouse** — хранилище пользовательских событий  
- **SQL-запросы** — извлечение и агрегация данных из таблиц
- **pandahouse** — подключение к ClickHouse и выполнение SQL-запросов  
- **pandas / matplotlib / seaborn** — анализ данных и построение графиков  
- **python-telegram-bot** — отправка готовых отчётов в Telegram
